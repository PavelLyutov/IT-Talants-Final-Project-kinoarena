...
import com.finals.kinoarena.util.exceptions.MethodArgumentTypeMismatchException;
...
public class MovieController extends AbstractController {
    ...
    public IMDBDataDTO findMoviesByName(@PathVariable(name = "title") String title) throws BadGetawayException, FileNotFoundException, InterruptedException {
